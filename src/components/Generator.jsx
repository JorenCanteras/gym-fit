...
import { SCHEMES, WORKOUTS } from '../utils/boosted'
...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} header={"generate your workout"} title={['It\'s', 'Huge', 'o\'clock']}>
            <Header index={'01'} title={'Pick your venum'} description={"Select the workout you wish to endure."} />
            ...
            <Header index={'03'} title={'Become Hercules'} description={"Select your ultimate objective."} />
            ...
            <Button className='py-10' func={updateWorkout} text={"Formulate"}></Button>
        </SectionWrapper>
